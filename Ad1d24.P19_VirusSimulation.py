...
y = odeint(FOV.sim, POV.y0_Ad1, FOV.t, args=(POV.params_Ad1,))
...
ax1.set_title("Volume of Tumor Treated with Ad1d24.P19 Virus Over Time")

ax2.set_title("Volume of Cells in Eclipse Phase Over Time")

ax3.set_title("Volume of Infected Cancer Cells Over Time")

ax4.set_title("Volume of Ad1d24.P19 Virus Over Time")
ax4.set_xlabel('Time')
...
#f, (ax1) = plt.subplots(1, sharex= True, sharey= False, figsize=(6,8))
#LineT, = ax1.plot(FOV.t, y[:,0], color="blue", label="LineT")
#ax1.set_title("Volume of Tumor Treated with Ad1d24.P19 Virus Over Time")
#ax1.set_xlabel('Time')
